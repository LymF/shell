...
THREADS=8
MEMORY=12G  # 12 GB for tools that accept GB
MEMORY_MB=12288  # 12 GB in MB for tools that require MB input

# Define paths to necessary files and tools
bowtie2_index="/home/lucas/rhodnius/bowtiedb/rhodniusDB"
diamond_db="/home/lucas/rhodnius/diamonddb/viraldb"  # Replace with the path to your Diamond database

# Directory containing the paired-end FASTQ files
fastq_dir="/home/lucas/rhodnius/Field_Rhodnius_Fastqs"  # Change to the directory where your FASTQ files are located
output_dir="/home/lucas/rhodnius/output"  # Directory to store all outputs
